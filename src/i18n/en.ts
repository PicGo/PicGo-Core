...
export const EN: ILocales = {
  ...
  UPLOAD_OPTION_INVALID_PARAMETER: 'Invalid upload option parameter "${parameter}": provide one non-empty string value.',
  UPLOAD_OPTION_ACTIVE_CONFIG: 'the active configuration (default ID, then first saved configuration)',
  UPLOAD_OPTION_UNKNOWN_UPLOADER: 'Uploader "${uploader}" is not registered. Available uploaders: ${uploaders}.',
  UPLOAD_OPTION_CONFIG_NOT_FOUND: 'No upload configuration matched ${selectors} in ${scope}.',
  UPLOAD_OPTION_CONFIG_AMBIGUOUS: 'Upload configuration ${selector} is ambiguous in ${scope}. Matches: ${candidates}. Specify an uploader or a unique configuration ID.',
  ...
  CLOUD_AUTH_STATUS_LOGGED_IN: 'Logged in to PicGo Cloud (user: ${user})',
