...
export const EN: ILocales = {
  ...
  CLOUD_ALBUM_IMPORT_AUTO_IMPORT_DISABLED: 'Cloud album import is disabled. Please enable auto import first.',
  ...
  CLOUD_ALBUM_IMPORT_PROMPT_ENABLE_AUTO_IMPORT: 'Cloud album import is disabled. Enable it now?',
