...
export const applyConfigSyncOptions = (cmd: Command): Command => {
  return cmd
...
export const createConfigSyncAction = (ctx: IPicGo) => {
  return async (options: { encrypt?: string | boolean; skipEncryptionSwitchConfirm?: boolean }): Promise<void> => {
